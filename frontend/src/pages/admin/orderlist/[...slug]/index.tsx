        ...
        <div className="px-7 py-4">
            ...
            <div>
              ...
              <div className='py-2 flex flex-row text-sm'>
                ...
                <span className='mx-4 px-2 bg-[#def2d0] text-[#245900] border rounded-md '>Product order</span>
                <Divider orientation="vertical" flexItem/>
                    ...
                    <div className="bg-white mb-6 p-4 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
                        ...
                        <div className='grid grid-cols-8 gap-4 mt-4'>
                          <div className='col-span-2'>
                            <img src="https://contents.mediadecathlon.com/p1988729/k$635c48fa4d35c20687c5afe2a3aada03/gi%C3%A0y-da-%C4%91%C3%A1-b%C3%B3ng-viralto-ii-tf-cho-nam-%C4%91en-kipsta-8612878.jpg?f=1200x0&format=auto" alt="" />
                          </div>
                          <div className='col-span-6 flex flex-col'>
                            ...
                            <input type="text" className="border rounded-sm border-[#ced4da] outline-none px-3 py-2 mt-1 mb-3 text-sm w-full" value={"ZOOM VAPOR 15 PRO TF"} disabled/>
                            <div className='flex flex-row items-center justify-between'>
                              <h1 className="text-sm font-semibold">Quantity</h1>
                            </div>
                            <input  className="border rounded-sm border-[#ced4da] outline-none px-3 py-2 mt-1 mb-1 text-sm w-full" value={"1"} disabled/>
                            <div className='flex flex-row items-center justify-between'>
                              <h1 className="text-sm font-semibold">Total Price</h1>
                            </div>
                            <input type="text" className="border rounded-sm border-[#ced4da] outline-none px-3 py-2 mt-1 mb-3 text-sm w-full" value={"$58.82"} disabled/>
                          </div>
                        </div>
